...
from mailAdd_test_check import MailAddTestCheck
...
class MailAddTestFlow:
    ...
    def start(self)->None:
        ...
        mailAdd_test_check:MailAddTestCheck = MailAddTestCheck(sime_day, is_test)
        submission_invoices: List[str] = mailAdd_test_check.find_submission_invoices()
        ...
        send_mail:MailAddTestSendMail = MailAddTestSendMail(yaml_data)
